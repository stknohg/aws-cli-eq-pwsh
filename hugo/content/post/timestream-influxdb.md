...
|----|----|
|[aws timestream-influxdb create-db-backup](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/timestream-influxdb/create-db-backup.html)|[New-TIDBDbBackup](https://docs.aws.amazon.com/powershell/latest/reference/items/New-TIDBDbBackup.html)|
...
|[aws timestream-influxdb delete-db-backup](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/timestream-influxdb/delete-db-backup.html)|[Remove-TIDBDbBackup](https://docs.aws.amazon.com/powershell/latest/reference/items/Remove-TIDBDbBackup.html)|
...
|[aws timestream-influxdb get-db-backup](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/timestream-influxdb/get-db-backup.html)|[Get-TIDBDbBackup](https://docs.aws.amazon.com/powershell/latest/reference/items/Get-TIDBDbBackup.html)|
...
|[aws timestream-influxdb list-db-backups](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/timestream-influxdb/list-db-backups.html)|[Get-TIDBDbBackupList](https://docs.aws.amazon.com/powershell/latest/reference/items/Get-TIDBDbBackupList.html)|
...
|[aws timestream-influxdb reboot-db-cluster](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/timestream-influxdb/reboot-db-cluster.html)|[Restart-TIDBDbCluster](https://docs.aws.amazon.com/powershell/latest/reference/items/Restart-TIDBDbCluster.html)|
|[aws timestream-influxdb reboot-db-instance](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/timestream-influxdb/reboot-db-instance.html)|[Restart-TIDBDbInstance](https://docs.aws.amazon.com/powershell/latest/reference/items/Restart-TIDBDbInstance.html)|
|[aws timestream-influxdb restore-from-db-backup](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/timestream-influxdb/restore-from-db-backup.html)|[Restore-TIDBFromDbBackup](https://docs.aws.amazon.com/powershell/latest/reference/items/Restore-TIDBFromDbBackup.html)|
