...
|----|----|
|[aws payment-cryptography add-key-replication-regions](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/payment-cryptography/add-key-replication-regions.html)|[Add-PAYCCKeyReplicationRegion](https://docs.aws.amazon.com/powershell/latest/reference/items/Add-PAYCCKeyReplicationRegion.html)|
|[aws payment-cryptography associate-mpa-team](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/payment-cryptography/associate-mpa-team.html)|[Add-PAYCCMpaTeam](https://docs.aws.amazon.com/powershell/latest/reference/items/Add-PAYCCMpaTeam.html)|
...
|[aws payment-cryptography delete-resource-policy](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/payment-cryptography/delete-resource-policy.html)|[Remove-PAYCCResourcePolicy](https://docs.aws.amazon.com/powershell/latest/reference/items/Remove-PAYCCResourcePolicy.html)|
|[aws payment-cryptography disable-default-key-replication-regions](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/payment-cryptography/disable-default-key-replication-regions.html)|[Disable-PAYCCDefaultKeyReplicationRegion](https://docs.aws.amazon.com/powershell/latest/reference/items/Disable-PAYCCDefaultKeyReplicationRegion.html)|
|[aws payment-cryptography disassociate-mpa-team](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/payment-cryptography/disassociate-mpa-team.html)|[Remove-PAYCCMpaTeam](https://docs.aws.amazon.com/powershell/latest/reference/items/Remove-PAYCCMpaTeam.html)|
...
|[aws payment-cryptography get-mpa-team-association](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/payment-cryptography/get-mpa-team-association.html)|[Get-PAYCCMpaTeamAssociation](https://docs.aws.amazon.com/powershell/latest/reference/items/Get-PAYCCMpaTeamAssociation.html)|
...
|[aws payment-cryptography get-resource-policy](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/payment-cryptography/get-resource-policy.html)|[Get-PAYCCResourcePolicy](https://docs.aws.amazon.com/powershell/latest/reference/items/Get-PAYCCResourcePolicy.html)|
...
|[aws payment-cryptography put-resource-policy](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/payment-cryptography/put-resource-policy.html)|[Write-PAYCCResourcePolicy](https://docs.aws.amazon.com/powershell/latest/reference/items/Write-PAYCCResourcePolicy.html)|
|[aws payment-cryptography remove-key-replication-regions](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/payment-cryptography/remove-key-replication-regions.html)|[Remove-PAYCCKeyReplicationRegion](https://docs.aws.amazon.com/powershell/latest/reference/items/Remove-PAYCCKeyReplicationRegion.html)|
