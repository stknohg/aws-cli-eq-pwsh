...
function Export-TopPageMarkdown {
    ...
    return & {
        ...
        "* [AWS Tools for PowerShell](https://aws.amazon.com/powershell/): {0} ([CHANGELOG](https://raw.githubusercontent.com/aws/aws-tools-for-powershell/master/CHANGELOG.md))" -f $cmdletVersion
        ""
        "### Contents"
        ""
        "{{< alert ""warning"" >}}"
