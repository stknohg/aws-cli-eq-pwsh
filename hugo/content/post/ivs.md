...
|[aws ivs create-ad-configuration](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ivs/create-ad-configuration.html)|[New-IVSAdConfiguration](https://docs.aws.amazon.com/powershell/latest/reference/items/New-IVSAdConfiguration.html)|
...
|[aws ivs delete-ad-configuration](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ivs/delete-ad-configuration.html)|[Remove-IVSAdConfiguration](https://docs.aws.amazon.com/powershell/latest/reference/items/Remove-IVSAdConfiguration.html)|
...
|[aws ivs get-ad-configuration](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ivs/get-ad-configuration.html)|[Get-IVSAdConfiguration](https://docs.aws.amazon.com/powershell/latest/reference/items/Get-IVSAdConfiguration.html)|
...
|[aws ivs insert-ad-break](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ivs/insert-ad-break.html)|[Add-IVSAdBreak](https://docs.aws.amazon.com/powershell/latest/reference/items/Add-IVSAdBreak.html)|
|[aws ivs list-ad-configurations](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ivs/list-ad-configurations.html)|[Get-IVSAdConfigurationList](https://docs.aws.amazon.com/powershell/latest/reference/items/Get-IVSAdConfigurationList.html)|
