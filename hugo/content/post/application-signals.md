...
|[aws application-signals delete-grouping-configuration](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/application-signals/delete-grouping-configuration.html)|[Remove-CWASGroupingConfiguration](https://docs.aws.amazon.com/powershell/latest/reference/items/Remove-CWASGroupingConfiguration.html)|
...
|[aws application-signals list-service-states](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/application-signals/list-service-states.html)|[Get-CWASServiceStateList](https://docs.aws.amazon.com/powershell/latest/reference/items/Get-CWASServiceStateList.html)|
...
|[aws application-signals put-grouping-configuration](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/application-signals/put-grouping-configuration.html)|[Write-CWASGroupingConfiguration](https://docs.aws.amazon.com/powershell/latest/reference/items/Write-CWASGroupingConfiguration.html)|
