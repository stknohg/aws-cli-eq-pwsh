...
|[aws frauddetector cancel-batch-import-job](https://docs.aws.amazon.com/cli/latest/reference/frauddetector/cancel-batch-import-job.html)||
...
|[aws frauddetector create-batch-import-job](https://docs.aws.amazon.com/cli/latest/reference/frauddetector/create-batch-import-job.html)||
...
|[aws frauddetector delete-batch-import-job](https://docs.aws.amazon.com/cli/latest/reference/frauddetector/delete-batch-import-job.html)||
...
|[aws frauddetector delete-events-by-event-type](https://docs.aws.amazon.com/cli/latest/reference/frauddetector/delete-events-by-event-type.html)||
...
|[aws frauddetector get-batch-import-jobs](https://docs.aws.amazon.com/cli/latest/reference/frauddetector/get-batch-import-jobs.html)||
...
|[aws frauddetector get-delete-events-by-event-type-status](https://docs.aws.amazon.com/cli/latest/reference/frauddetector/get-delete-events-by-event-type-status.html)||
...
|[aws frauddetector get-event](https://docs.aws.amazon.com/cli/latest/reference/frauddetector/get-event.html)||
...
|[aws frauddetector send-event](https://docs.aws.amazon.com/cli/latest/reference/frauddetector/send-event.html)||
...
|[aws frauddetector update-event-label](https://docs.aws.amazon.com/cli/latest/reference/frauddetector/update-event-label.html)||
