...
|[aws launch-wizard get-deployment-pattern-version](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/launch-wizard/get-deployment-pattern-version.html)|[Get-LWIZDeploymentPatternVersion](https://docs.aws.amazon.com/powershell/latest/reference/items/Get-LWIZDeploymentPatternVersion.html)|
...
|[aws launch-wizard list-deployment-pattern-versions](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/launch-wizard/list-deployment-pattern-versions.html)|[Get-LWIZDeploymentPatternVersionList](https://docs.aws.amazon.com/powershell/latest/reference/items/Get-LWIZDeploymentPatternVersionList.html)|
...
|[aws launch-wizard update-deployment](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/launch-wizard/update-deployment.html)|[Update-LWIZDeployment](https://docs.aws.amazon.com/powershell/latest/reference/items/Update-LWIZDeployment.html)|
