...
|[aws gameliftstreams create-stream-url](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/gameliftstreams/create-stream-url.html)|[New-GMLSStreamUrl](https://docs.aws.amazon.com/powershell/latest/reference/items/New-GMLSStreamUrl.html)|
...
|[aws gameliftstreams get-stream-url](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/gameliftstreams/get-stream-url.html)|[Get-GMLSStreamUrl](https://docs.aws.amazon.com/powershell/latest/reference/items/Get-GMLSStreamUrl.html)|
|[aws gameliftstreams list-application-shader-caches](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/gameliftstreams/list-application-shader-caches.html)|[Get-GMLSApplicationShaderCacheList](https://docs.aws.amazon.com/powershell/latest/reference/items/Get-GMLSApplicationShaderCacheList.html)|
...
|[aws gameliftstreams list-stream-urls](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/gameliftstreams/list-stream-urls.html)|[Get-GMLSStreamUrlList](https://docs.aws.amazon.com/powershell/latest/reference/items/Get-GMLSStreamUrlList.html)|
...
|[aws gameliftstreams revoke-stream-url](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/gameliftstreams/revoke-stream-url.html)|[Revoke-GMLSStreamUrl](https://docs.aws.amazon.com/powershell/latest/reference/items/Revoke-GMLSStreamUrl.html)|
