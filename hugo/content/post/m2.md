...
|[aws m2 create-data-set-export-task](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/m2/create-data-set-export-task.html)|[New-AMMDataSetExportTask](https://docs.aws.amazon.com/powershell/latest/reference/items/New-AMMDataSetExportTask.html)|
...
|[aws m2 get-data-set-export-task](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/m2/get-data-set-export-task.html)|[Get-AMMDataSetExportTask](https://docs.aws.amazon.com/powershell/latest/reference/items/Get-AMMDataSetExportTask.html)|
...
|[aws m2 list-data-set-export-history](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/m2/list-data-set-export-history.html)|[Get-AMMDataSetExportHistoryList](https://docs.aws.amazon.com/powershell/latest/reference/items/Get-AMMDataSetExportHistoryList.html)|
