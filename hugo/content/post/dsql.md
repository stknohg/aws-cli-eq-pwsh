...
|[aws dsql create-stream](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/dsql/create-stream.html)|[New-DSQLStream](https://docs.aws.amazon.com/powershell/latest/reference/items/New-DSQLStream.html)|
...
|[aws dsql delete-cluster-policy](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/dsql/delete-cluster-policy.html)|[Remove-DSQLClusterPolicy](https://docs.aws.amazon.com/powershell/latest/reference/items/Remove-DSQLClusterPolicy.html)|
|[aws dsql delete-stream](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/dsql/delete-stream.html)|[Remove-DSQLStream](https://docs.aws.amazon.com/powershell/latest/reference/items/Remove-DSQLStream.html)|
...
|[aws dsql get-cluster-policy](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/dsql/get-cluster-policy.html)|[Get-DSQLClusterPolicy](https://docs.aws.amazon.com/powershell/latest/reference/items/Get-DSQLClusterPolicy.html)|
|[aws dsql get-stream](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/dsql/get-stream.html)|[Get-DSQLStream](https://docs.aws.amazon.com/powershell/latest/reference/items/Get-DSQLStream.html)|
...
|[aws dsql list-streams](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/dsql/list-streams.html)|[Get-DSQLStreamList](https://docs.aws.amazon.com/powershell/latest/reference/items/Get-DSQLStreamList.html)|
...
|[aws dsql put-cluster-policy](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/dsql/put-cluster-policy.html)|[Set-DSQLClusterPolicy](https://docs.aws.amazon.com/powershell/latest/reference/items/Set-DSQLClusterPolicy.html)|
