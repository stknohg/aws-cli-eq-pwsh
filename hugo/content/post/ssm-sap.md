...
|[aws ssm-sap get-configuration-check-operation](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ssm-sap/get-configuration-check-operation.html)|[Get-SMSAPConfigurationCheckOperation](https://docs.aws.amazon.com/powershell/latest/reference/items/Get-SMSAPConfigurationCheckOperation.html)|
...
|[aws ssm-sap list-configuration-check-definitions](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ssm-sap/list-configuration-check-definitions.html)|[Get-SMSAPConfigurationCheckDefinitionList](https://docs.aws.amazon.com/powershell/latest/reference/items/Get-SMSAPConfigurationCheckDefinitionList.html)|
|[aws ssm-sap list-configuration-check-operations](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ssm-sap/list-configuration-check-operations.html)|[Get-SMSAPConfigurationCheckOperationList](https://docs.aws.amazon.com/powershell/latest/reference/items/Get-SMSAPConfigurationCheckOperationList.html)|
...
|[aws ssm-sap list-sub-check-results](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ssm-sap/list-sub-check-results.html)|[Get-SMSAPSubCheckResultList](https://docs.aws.amazon.com/powershell/latest/reference/items/Get-SMSAPSubCheckResultList.html)|
|[aws ssm-sap list-sub-check-rule-results](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ssm-sap/list-sub-check-rule-results.html)|[Get-SMSAPSubCheckRuleResultList](https://docs.aws.amazon.com/powershell/latest/reference/items/Get-SMSAPSubCheckRuleResultList.html)|
...
|[aws ssm-sap start-configuration-checks](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ssm-sap/start-configuration-checks.html)|[Start-SMSAPConfigurationCheck](https://docs.aws.amazon.com/powershell/latest/reference/items/Start-SMSAPConfigurationCheck.html)|
